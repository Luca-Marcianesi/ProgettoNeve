...
# Vista dell'attrezzatura singola da parte del account prorpietario
class VistaAttrezzaturaProprietario(QWidget):
    def __init__(self, callback, attrezzatura, rimuovi, aggiorna):
        ...
        # Funzione utile per la rimozione della vista dell'attuale attrezzatura
        ...
        # Funzione che si occupa di settare e allineare i pulsanti "Indietro" e "Elimina"
    ...
    # Metodo per creazione, stile e funzionamento dei bottoni indietro e elimina
    ...
    # Metodo che permette la rimozione dell'attrezzatura
    def elimina(self):
