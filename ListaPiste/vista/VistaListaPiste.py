...
class VistaListaPiste(QWidget):
    def __init__(self, callback):
        ...
        # Funzione standard che imposta lo sfondo alla vista
        ...
        # Funzione che configura tutti i pulsanti per ogni pista
    ...
    # Metodo che mostra la vista pista relativa alla pista selezionata
    ...
    # Metodo che configura il pulsante indietro
    def show_pulsante_indietro(self):
        ...
        self.layout_orizzontale.addSpacerItem(QSpacerItem(5, 0))
        self.layout_orizzontale.addWidget(pulsante_indietro)
        self.layout_orizzontale.addSpacerItem(QSpacerItem(5000, 0))
        self.layout_verticale1.addLayout(self.layout_orizzontale)

    # Metodo che si occupa dell'allineamento dei pulsanti di ogni pista
