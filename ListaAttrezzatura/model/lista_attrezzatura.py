...
class listaAttrezzatura:
    ...
    def prenota_attrezzatura(self, codice):
        for attrezzatura in self.lista_attrezzatura:
            if attrezzatura.get_codice() == codice:
                sessione.aggiungi_prenotazione(prenotazione(attrezzatura.get_codice(),"",attrezzatura.get_nome()))
        ...
        if os.path.isfile('ListaAttrezzatura/data/lista_attrezzatura.pickle'):
            with open('ListaAttrezzatura/data/lista_attrezzatura.pickle',"rb") as file:
                ...
                for attrezzatura_da_caricare in lista_attrezzatura:
                    self.aggiungi_attrezzatura(attrezzatura(attrezzatura_da_caricare["nome"],
                                                            attrezzatura_da_caricare["codice"],
